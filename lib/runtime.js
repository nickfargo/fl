...
(function() {
  var ArrayIterator, ConcatIterator, CycleIterator, DropIterator, EmptyIterator, FilterIterator, InterleaveIterator, IterateIterator, IteratorOutput, MapIterator, MapIterator_variadic, PairwiseArrayIterator, PartitionByIterator, PartitionIterator, RangeIterator, ReductionIterator, RepeatIterator, TakeIterator, assertUnfinished, callable, compare, complement, concat, cycle, decrement, dropWhile, empty, filter, generatorOf, identity, increment, interleave, isEven, isOdd, iterate, iteratorOf, map, multiply, partition, partitionBy, range, reduce, reductions, repeat, slice, sum, takeWhile, throwIteratorFinished, throwNotSequential, toArray, __map_one__, __map_variadic__, __send_part_to_output__, __send_to_output__;
  ...
  module.exports = {
    ...
    PartitionByIterator: PartitionByIterator,
