...
(function() {
  ...
  __part_send__ = function(out, value, done) {
    out.value = value;
    out.done = done;
    return out;
  };

  __part_sendArraySequence__ = function(out, array) {
    return __part_send__(out, (array != null ? new ArrayIterator(array.slice()) : void 0), false);
  };
  ...
  PartitionIterator = (function() {
    ...
    PartitionIterator.prototype.next = function() {
      ...
      assertUnfinished(out);
      if (this.source == null) {
        return __part_send__(out, void 0, true);
      }
      i = 0;
