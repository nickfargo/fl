...
(function() {
  ...
  generatorOf = function(iterable) {
    if (iterable == null) {
      ...
      return function() {
        return (typeof iterable === "function" ? iterable() : void 0) || (typeof iterable.__iterator__ === "function" ? iterable.__iterator__() : void 0) || (typeof iterable.next === 'function' ? iterable : void 0) || (iterable.length != null ? new ArrayIterator(iterable) : void 0) || empty();
      };
    }
  };
  ...
  CycleIterator = (function() {
    function CycleIterator(sequence) {
      ...
      this.source = (callable(sequence)).call();
      this.out = new IteratorOutput;
    }
    ...
    CycleIterator.prototype.next = function() {
      ...
      if (done) {
        this.source = (callable(this.sequence)).call();
        _ref1 = this.source.next(), value = _ref1.value, done = _ref1.done;
      }
      out.value = value;
      out.done = done;
      return out;
  ...
  filter = function(predicate, sequence) {
    return function() {
      return new FilterIterator(predicate, (callable(sequence)).call());
    };
  };
  ...
  map = function(fn, sequence, rest) {
    ...
    if (sequence == null) {
      ...
      return function() {
        return new MapIterator(fn, (callable(sequence)).call());
      };
    } else {
      ...
      return function() {
        return new MapIterator_variadic(fn, sequences);
      };
    }
  };
  ...
  reductions = function(fn, seed, sequence) {
    ...
    return function() {
      return new ReductionIterator(fn, seed, (callable(sequence)).call());
    };
  };
  ...
  ConcatIterator = (function() {
    function ConcatIterator(sequences) {
      ...
      this.source = (callable(sequences[0])).call();
      this.index = 0;
      this.out = new IteratorOutput;
    }
  ...
  partition = function(size, stride, padding, sequence) {
    switch (arguments.length) {
      ...
      default:
        return function() {
          return new PartitionIterator(size, stride, padding, (callable(sequence)).call());
        };
    }
  };

  PartitionIterator = (function() {
    var pad, send, sendPart;
    ...
    pad = function(part, padding, amount) {
      ...
      if ((padding != null) && (source = (callable(padding)).call())) {
        i = 0;
        while (i < amount) {
          _ref = source.next(), value = _ref.value, done = _ref.done;
          if (done) {
    ...
    send = function(out, value, done) {
      out.value = value;
      out.done = done;
      return out;
    };

    sendPart = function(out, part) {
      return send(out, (part != null ? new ArrayIterator(part) : void 0), false);
    };
  ...
  takeWhile = function(predicate, sequence) {
    return function() {
      return new TakeIterator(predicate, (callable(sequence)).call());
    };
  };
  ...
  dropWhile = function(predicate, sequence) {
    return function() {
      return new DropIterator(predicate, (callable(sequence)).call());
    };
  };
