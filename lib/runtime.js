...
(function() {
  var ArrayIterator, ConcatIterator, CycleIterator, DropIterator, EmptyIterator, FilterIterator, InterleaveIterator, IterateIterator, IteratorOutput, MapIterator, MapIterator_variadic, PairwiseArrayIterator, PartitionIterator, RangeIterator, ReductionIterator, RepeatIterator, TakeIterator, assertUnfinished, callable, compare, complement, concat, cycle, decrement, dropWhile, empty, filter, flatten, generatorOf, identity, increment, interleave, isEven, isOdd, iterate, map, multiply, partition, range, reduce, reductions, repeat, rest, slice, sum, takeWhile, throwIteratorFinished, toArray;
  ...
  generatorOf = function(iterable) {
    ...
    } else if ((iterable.length != null) && typeof iterable.splice === 'function') {
      return function() {
