...
(function() {
  ...
  module.exports = Sequence = (function() {
    var ARGUMENT_AND_SEQUENCE_AND_REST_TO_SEQUENCE, FUNCTION_TO_FUNCTION, REST_AND_SEQUENCE_TO_SEQUENCE, SEQUENCE_AND_REST_TO_SEQUENCE, SEQUENCE_TO_VALUE, VALUE_TO_SEQUENCE, VALUE_TO_VALUE, fn, generatorOf, name, slice, _ref;

    slice = Array.prototype.slice;

    generatorOf = operators.functions.generatorOf;

    _ref = operators.signatures, VALUE_TO_VALUE = _ref[0], FUNCTION_TO_FUNCTION = _ref[1], VALUE_TO_SEQUENCE = _ref[2], SEQUENCE_TO_VALUE = _ref[3], SEQUENCE_AND_REST_TO_SEQUENCE = _ref[4], ARGUMENT_AND_SEQUENCE_AND_REST_TO_SEQUENCE = _ref[5], REST_AND_SEQUENCE_TO_SEQUENCE = _ref[6];
    ...
    Sequence.prototype.call = function(context) {
      return this.generator.apply(context, slice.call(arguments, 1));
    };
    ...
    for (name in ARGUMENT_AND_SEQUENCE_AND_REST_TO_SEQUENCE) {
      fn = ARGUMENT_AND_SEQUENCE_AND_REST_TO_SEQUENCE[name];
      Sequence.prototype[name] = (function(fn) {
        return function() {
          var a, aa;
          a = arguments[0], aa = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
          return new Sequence(fn.apply(null, [a, this].concat(__slice.call(aa))));
        };
      })(fn);
    }
