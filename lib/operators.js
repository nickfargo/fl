...
(function() {
  var apply, callable, complement, concat, cycle, decrement, drop, dropUntil, dropWhile, filter, generatorOf, identity, increment, interleave, interpose, isEven, isOdd, iterate, map, multiply, nullGenerator, partition, partitionBy, range, reduce, reductions, remove, repeat, rest, splitAt, splitWith, sum, take, takeUntil, takeWhile, toArray, _ref;
