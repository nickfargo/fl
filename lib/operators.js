...
(function() {
  var apply, compare, complement, compose, concat, cycle, decrement, drop, dropWhile, empty, filter, first, generatorOf, identity, increment, interleave, interpose, isEven, isOdd, iterate, iteratorOf, map, multiply, partial, partition, partitionBy, range, reduce, reductions, remove, repeat, rest, slice, splitAt, splitWith, sum, take, takeWhile, toArray, _ref;
