...
(function() {
  var apply, compare, complement, compose, concat, cycle, decrement, drop, dropWhile, empty, filter, first, generatorOf, identity, increment, interleave, interpose, isEven, isOdd, iterate, iteratorOf, map, multiply, partial, partition, partitionBy, range, reduce, reductions, remove, repeat, rest, slice, sort, splitAt, splitWith, sum, take, takeWhile, toArray, _ref;

  _ref = require('./runtime'), generatorOf = _ref.generatorOf, iteratorOf = _ref.iteratorOf, sum = _ref.sum, multiply = _ref.multiply, compare = _ref.compare, toArray = _ref.toArray, empty = _ref.empty, repeat = _ref.repeat, cycle = _ref.cycle, iterate = _ref.iterate, interleave = _ref.interleave, range = _ref.range, filter = _ref.filter, map = _ref.map, reduce = _ref.reduce, reductions = _ref.reductions, concat = _ref.concat, partition = _ref.partition, partitionBy = _ref.partitionBy, takeWhile = _ref.takeWhile, dropWhile = _ref.dropWhile;
