...
(function() {
  var apply, callable, complement, concat, cycle, decrement, drop, dropUntil, dropWhile, filter, generatorOf, identity, increment, interleave, interpose, isEven, isOdd, iterate, map, multiply, nullGenerator, partition, range, reduce, reductions, remove, repeat, rest, splitAt, splitWith, sum, take, takeUntil, takeWhile, toArray, _ref;

  _ref = require('./runtime'), identity = _ref.identity, increment = _ref.increment, decrement = _ref.decrement, isEven = _ref.isEven, isOdd = _ref.isOdd, sum = _ref.sum, multiply = _ref.multiply, complement = _ref.complement, nullGenerator = _ref.nullGenerator, generatorOf = _ref.generatorOf, callable = _ref.callable, rest = _ref.rest, repeat = _ref.repeat, cycle = _ref.cycle, iterate = _ref.iterate, interleave = _ref.interleave, range = _ref.range, filter = _ref.filter, map = _ref.map, reduce = _ref.reduce, reductions = _ref.reductions, concat = _ref.concat, partition = _ref.partition, takeWhile = _ref.takeWhile, dropWhile = _ref.dropWhile, toArray = _ref.toArray;
