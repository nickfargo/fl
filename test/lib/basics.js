...
(function() {
  var Sequence, apply, cycle, expect, increment, interleave, interpose, iterate, map, range, reduce, reductions, repeat, rest, sum, take, toArray, _ref;

  expect = require('chai').expect;

  _ref = require('fl'), Sequence = _ref.Sequence, map = _ref.map, sum = _ref.sum, increment = _ref.increment, rest = _ref.rest, repeat = _ref.repeat, cycle = _ref.cycle, iterate = _ref.iterate, range = _ref.range, apply = _ref.apply, reduce = _ref.reduce, reductions = _ref.reductions, interleave = _ref.interleave, interpose = _ref.interpose, take = _ref.take, toArray = _ref.toArray;
